...
> *"A relation R is in BCNF if and only if: whether there is a nontrivial FD A<sub>1</sub>A(~2~)...A~n~ → B~1~B~2~...B~m~ for R, it is the case that {A~1~, A~2~, ..., A~n~} is a super key for R"*
